    ...
    <form action="" method="post" class="container justify-content-center col-12" enctype="multipart/form-data">
      <div class="col-12 row m-3 justify-content-center">
        <div class="col-6 ">
          ...
          <input type="text" class="form-control" style="width: 100%;" name="titulo"
            value="<?= $Funciones->old('titulo') ?>">
        </div>
      </div>
      ...
      <div class="col-12 row m-3 justify-content-center">
        <div class="col-4">
          ...
          <input type="file" class="form-control" style="width: 100%;" name="fileUpload" onchange="readURL(this)">
        </div>
      </div>
      ...
      <div class="row m-3 justify-content-center">
        <div class="col-6">
          ...
          <textarea name="historia" class="form-control text-start" id="summernote" rows="10"
            style="width: 100%; text-align: justify; "><?= $Funciones->old('historia') ?></textarea>
        </div>
      </div>
